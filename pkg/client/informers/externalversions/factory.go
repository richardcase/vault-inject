...
type SharedInformerFactory interface {
	...
	Vaultinject() vaultinject.Interface
}

func (f *sharedInformerFactory) Vaultinject() vaultinject.Interface {
	return vaultinject.New(f, f.namespace, f.tweakListOptions)
}
