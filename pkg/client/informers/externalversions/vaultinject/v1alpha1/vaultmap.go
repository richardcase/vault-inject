	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VaultinjectV1alpha1().VaultMaps(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VaultinjectV1alpha1().VaultMaps(namespace).Watch(options)
			},
		},
		&vaultinject_v1alpha1.VaultMap{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vaultMapInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vaultinject_v1alpha1.VaultMap{}, f.defaultInformer)
}
