...
import (
	...
	scheme "github.com/richardcase/vault-admission/pkg/client/clientset/versioned/scheme"
...
func newVaultMaps(c *VaultinjectV1alpha1Client, namespace string) *vaultMaps {
	return &vaultMaps{
		client: c.RESTClient(),
		ns:     namespace,
	}
