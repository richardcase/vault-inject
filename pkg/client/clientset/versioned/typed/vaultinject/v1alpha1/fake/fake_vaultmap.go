...
type FakeVaultMaps struct {
	Fake *FakeVaultinjectV1alpha1
	ns   string
}

var vaultmapsResource = schema.GroupVersionResource{Group: "vaultinject.k8s.io", Version: "v1alpha1", Resource: "vaultmaps"}

var vaultmapsKind = schema.GroupVersionKind{Group: "vaultinject.k8s.io", Version: "v1alpha1", Kind: "VaultMap"}
